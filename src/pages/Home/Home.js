        ...
        <div className="banner-container">
              <div className='banner-content'>
                ...
                <div>
                    ...
                    <h1 className="text-5xl sm:text-5xl lg:text-7xl my-3">Party Rider Club</h1>
                    <h3 className="text-xl">Find private parties happening near you fast</h3>
                </div>
                  <div className='bg-primaryColor w-full md:w-2/5 my-6 rounded-full h-14 m-auto flex items-center justify-center text-2xl'>
                      <span className='text-3xl mr-2'>340,200</span>
                      Members
                  </div>
                  <div className="border rounded-full h-16 flex mt-8">
